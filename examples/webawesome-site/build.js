#!/usr/bin/env node
/**
 * Deployment assembly script for Web Awesome site
...
// Configuration
const BASE_PATH = process.env.BASE_PATH || '/sample/trailhead/webawesome';
const OUTPUT_DIR = join(__dirname, 'dist');

console.log('Assembling Web Awesome site for deployment...');
