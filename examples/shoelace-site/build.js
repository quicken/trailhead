#!/usr/bin/env node
/**
 * Deployment assembly script for Shoelace site
...
// Configuration
const BASE_PATH = process.env.BASE_PATH || '/sample/trailhead/shoelace';
const OUTPUT_DIR = join(__dirname, 'dist');

console.log('Assembling Shoelace site for deployment...');
